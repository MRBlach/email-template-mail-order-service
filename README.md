...
Responsive email template for e-commerce. Promote your online store. Social media icons for networking.
...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/MRBlach/email-template-mail-order-service/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/MRBlach/email-template-mail-order-service/issues/new). Please include sample queries and their corresponding results.
